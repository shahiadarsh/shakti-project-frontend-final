  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "divine-pulse": {
          "0%, 100%": { 
            boxShadow: "0 0 20px hsl(45 100% 68% / 0.3)",
            transform: "scale(1)"
          },
          "50%": { 
            boxShadow: "0 0 40px hsl(45 100% 68% / 0.6)",
            transform: "scale(1.02)"
          },
        },
        "aura-glow": {
          "0%, 100%": { filter: "drop-shadow(0 0 20px hsl(45 100% 68% / 0.5))" },
          "50%": { filter: "drop-shadow(0 0 40px hsl(45 100% 68% / 0.8))" },
        },
        "mandala-rotate": {
